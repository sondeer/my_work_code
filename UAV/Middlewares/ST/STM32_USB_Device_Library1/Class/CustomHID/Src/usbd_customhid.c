                              ...
                              uint8_t epnum)
{
  ...
  USBD_CUSTOM_HID_HandleTypeDef     *hhid = (USBD_CUSTOM_HID_HandleTypeDef*)pdev->pClassData;  
	...
	memcpy(buff,hhid->Report_buf,USBD_CUSTOMHID_OUTREPORT_BUF_SIZE);
	((USBD_CUSTOM_HID_ItfTypeDef *)pdev->pUserData)->OutEvent(buff,USBD_CUSTOMHID_OUTREPORT_BUF_SIZE);
